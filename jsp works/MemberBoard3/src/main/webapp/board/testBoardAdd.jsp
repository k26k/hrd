...
<body>
	...
	<div class="container mt-4">
		<form action="/testBoardAddProcess.do" method="post" class="col-12 col-md-10 col-xl-8 col-xxl-7">
			<div class="row mx-0 mt-4">
				<label class="col-form-label col-12 col-lg-2 my-2 text-center" for="title">제목</label>
				<div class="col-12 col-lg-10 my-2">
					<input type="text" id="title" name="title" class="form-control" value="<c:out value="test_${ num }"/>">
				</div>
			</div>
			<div class="row mx-0 mt-4">
				<label class="col-12 col-lg-2 my-2 pt-2 text-center" for="content">내용</label>
				<div class="col-12 col-lg-10 my-2" >
					<textarea class="form-control" id="content" name="content" style="resize: none; min-height: 250px; height: 298px;" onkeydown='resize(this)' onkeyup='resize(this)'><c:out value="${ board.content }"/><c:out value="test_${ num }"/></textarea>
				</div>
			</div>
