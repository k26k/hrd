...
<body>
	...
	<div class="container">
		<form action="/wm1/processShippingInfo.jsp?cartId=<%= request.getParameter("cartId") %>" class="form-horizontal" method="post" >
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10">
					<a href="/wm1/cart.jsp" class="btn btn-secondary" role="button">이전</a>
					<input type="submit" class="btn btn-primary" value="등록">
					<a href='/wm1/checkOutCancelled.jsp' class="btn btn-secondary" role="button">이전</a>
				</div>
			</div>
		</form>
	</div>
