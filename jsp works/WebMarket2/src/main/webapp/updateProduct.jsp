...
<body>
	...
	<div class="container">
		...
		<form name="newProduct" action="/wm2/processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<div class="col-sm-4">
					<img alt="<%= product.getProductImage() %>" src="/wm2/upload/images/<%= product.getProductImage() %>" width="100%">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2" for="productId"><fmt:message key="productId"/></label>
				<div class="col-sm-3">
					<input type="text" id="productId" name="productId" class="form-control" value="<%= product.getProductId() %>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="description" name="description" class="form-control" value="<%= product.getDescription() %>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="category" name="category" class="form-control" value="<%= product.getCategory() %>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="radio" name="condition" value="New" <% if(product.getCondition().equals("New")){ %> checked <% } %>><label class="col-sm-3"><fmt:message key="condition_New"/></label>
					<input type="radio" name="condition" value="Old" <% if(product.getCondition().equals("Old")){ %> checked <% } %>><label class="col-sm-3"><fmt:message key="condition_Old"/></label>
					<input type="radio" name="condition" value="Refurbished" <% if(product.getCondition().equals("Refurbished")){ %> checked <% } %>><label class="col-sm-3"><fmt:message key="condition_Refurbished"/></label>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="checkbox" id="productImageChange" name="productImageChange" onchange="if(productImageChange.checked){productImage.disabled=true;}else{productImage.disabled=false;}">
					<label for="productImageChange">상품 이미지 그대로 사용</label>
				</div>
			</div>
			<div class="form-group row">
