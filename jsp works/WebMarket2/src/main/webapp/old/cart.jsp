	...
	<div class="row">
		...
		<c:forEach var="product" items="${sessionScope.cartList}">
			...
			<div class="row col-md-12">
				<div class="col-md-3">
					<a href='/wm2/product.jsp?id=<c:out value="${ product.productId }"/>'>
						<img src="/wm2/upload/images/<c:out value="${ product.filename }"/>" style="width: 100%;">
					</a>
				</div>
				<div class="col-md-7">
		...
		<div class="col-md-2 ">
			<a href='/wm2/shippingInfo.jsp?cartId=<%= cartId %>' class="btn btn-info col-xs-4 col-md-12 my-1" >결제 하기</a>
			<a href='/wm2/deleteCart.jsp' class="btn btn-warning my-1">전체 삭제</a>
			<a href="/wm2/products.jsp" class="btn btn-secondary my-1">상품 보러가기</a>
		</div>
	</div>
	</c:otherwise>
	</c:choose>
