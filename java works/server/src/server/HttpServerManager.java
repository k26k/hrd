...
//            		System.out.println("Y favicon.ico");
//            	}else {
//            		System.out.println("N favicon.ico");
//            	}
...
//                sb.append("       <span>QueryString: "+(exchange.getRequestURI().getQuery())+"</span></br>");
            	...
            	if(url.equals("/")) {
//            		System.out.println("Y : "+exchange.getRequestURI().getPath());
            		sb.append("        <img src='https://www.dolfarmer.com/contents/images/logo_share.png'>");
            	}else {
//            		System.out.println("N : ["+exchange.getRequestURI().getPath()+"]");
