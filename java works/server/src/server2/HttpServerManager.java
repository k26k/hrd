...
public class HttpServerManager {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 서버 생성
            httpServerManager = new HttpServerManager("localhost", 80);
...
//                	sb.append("["+urls[i]+"]<br>");	
                ...
                if(urls.length==0){
                	sb.append("<img src='https://www.dolfarmer.com/contents/images/logo_share.png'>");
                	sb.append(div("","냉무"));
...
//              ========= 바디 생성 ========
    ...
    private void  makeHead(StringBuilder sb) {
        ...
        sb.append("    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css' rel='stylesheet' integrity='sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3' crossorigin='anonymous'>");
        sb.append("    <script src='https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js'></script>");
        sb.append("    <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js' integrity='sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p' crossorigin='anonymous'></script>");
        sb.append("</head>");
    }
    
    private String div(String cl, String obj){
    	return ("<div class='"+cl+"'>"+obj+"</div>");
    }
