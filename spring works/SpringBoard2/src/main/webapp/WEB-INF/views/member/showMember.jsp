...
<security:authentication property="principal.memberVO" var="memberVO"/>
			...
			<form action="/updateMemberProcess" method="post" onsubmit="return (checkMember()==true)">
				<table>
					...
					<tr>
						...
						<td><input type="text" class="max" id="regDate" name="regDat" ></td>
					</tr>
					<tr>
						<td class="gray"><label for="updateDate">수정일</label></td>
						<td><input type="text" class="max" id="regDate" name="regDate" ></td>
					</tr>
					<tr>
						<td colspan="2">
